        ...
        @if (auth()->user()->role == 'admin')
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    ...
                    <a href="{{ route('grade.index') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-primary">
                    ...
                    <a href="{{ route('exam.index') }}" class="small-box-footer">More info <i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
        ...
        @if (auth()->user()->role == 'teacher')
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    ...
                    <a href="{{ route('attendance.create') }}" class="small-box-footer">Take Attendence<i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="{{ route('result.create') }}" class="small-box-footer">Prepare Result<i
                            class="fas fa-arrow-circle-right"></i></a>
                </div>
            </div>
        @endif
          @if (auth()->user()->role == 'student')
               ...
               @include('backend.dashboard.student')
          @endif
    </div>
    <!-- ./col -->
