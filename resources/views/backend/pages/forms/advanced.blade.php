...
<head>
  ...
  <link rel="stylesheet" href="{{asset('backend_assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.min.css')}}">
  ...
  <link rel="stylesheet" href="{{asset('backend_assets/plugins/bootstrap4-duallistbox/bootstrap-duallistbox.min.css')}}">
  <!-- BS Stepper -->
  <link rel="stylesheet" href="{{asset('backend_assets/plugins/bs-stepper/css/bs-stepper.min.css')}}">
  <!-- dropzonejs -->
  <link rel="stylesheet" href="{{asset('backend_assets/plugins/dropzone/min/dropzone.min.css')}}">
  <!-- Theme style -->
